...
export default async function Nav ( { params }: NavProps )
{
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-10 grid grid-cols-2 gap-2 md:flex justify-between items-center py-3 bg-white backdrop-blur-md bg-opacity-60 border-b border-cyan-400 mb-6 md:gap-8 px-4 md:px-8 lg:px-20">
