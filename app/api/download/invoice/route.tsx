...
<body style="background-color: #f3f3f3;">
    <div class="container">
        ...
        <div class="section">
            <h2 style="padding: 20px 0 10px 0;">Hotel Sunshine</h2>
            <hr style="height: 1px; background-color:teal; margin:0;"/>
        </div>
        <div class="section">
            <h3 style="padding: 20px 0 10px 0; color:teal">Guest Information</h3>
            <div style="background-color: #e3e3e3; padding:20px; border-radius:10px;">
                <p style="font-size: 15px; color: #080808">Name: meherish</p>
                <p style="font-size: 15px; color: #080808 ;padding:10px 0 0 0; ">Email: meherish@testme.com</p>
            </div>
        </div>
        <div class="section">
            ...
            <div style="background-color: #c9e2e9; padding:20px; border-radius:10px;">
                ...
                <tr>
                    ...
                    <td style="font-size: 15px; color: #080808; padding: 5px;">04/01/2025</td>
                </tr>
                <tr>
                    <td style="font-size: 15px; color: #080808; padding: 5px;">Check-out:</td>
                    <td style="font-size: 15px; color: #080808; padding: 5px;">05/01/2025</td>
                </tr>
                <tr>
        ...
        <div class="section">
            <h3 style="padding: 0px 0 10px 0; color:teal">Billing Address</h3>
            <div style="background-color: #e3e3e3; padding:20px; border-radius:10px; display:flex; gap: 20px; flex-direction:column;">
                <div style="display: flex; gap:30px;">
                    <p >Street: Laboriosam tempora</p>
                    <p >City: Commodo aliquid est</p>
                </div>
                <div style="display: flex; gap:30px;">
                    <p >State: Earum aut commodo do</p>
                    <p >ZIP Code: 68527</p>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <h3 style="padding: 0px 0 10px 0; color:teal">Payment Summary</h3>
            <!-- bill -->
    ...
    <tr>
        ...
        <div style="padding:10px;" class="contact">
            <p>Hotel Sunshine</p>
            <p>Los Angeles, California, USA, 42028</p>
